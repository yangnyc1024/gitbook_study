...
* [Deep Learning](deep-learning/README.md)
  ...
  * [Transformer and Attention Mechanism](deep-learning/transformer-and-attention-mechanism/README.md)
    ...
    * [Attemtion is all you need](deep-learning/transformer-and-attention-mechanism/attemtion-is-all-you-need/README.md)
      * [Attention and Kernel](deep-learning/transformer-and-attention-mechanism/attemtion-is-all-you-need/attention-and-kernel.md)
      * [Attention Scoring Functions](deep-learning/transformer-and-attention-mechanism/attemtion-is-all-you-need/attention-scoring-functions.md)
      * [The Bahdanau Attention Mechanism](deep-learning/transformer-and-attention-mechanism/attemtion-is-all-you-need/the-bahdanau-attention-mechanism.md)
      * [Multi-Head Attention](deep-learning/transformer-and-attention-mechanism/attemtion-is-all-you-need/multi-head-attention.md)
      * [Self-Attention](deep-learning/transformer-and-attention-mechanism/attemtion-is-all-you-need/self-attention.md)
    * [The Transformer Architecture](deep-learning/transformer-and-attention-mechanism/the-transformer-architecture/README.md)
      * [最短的最大路径长度](deep-learning/transformer-and-attention-mechanism/the-transformer-architecture/zui-duan-de-zui-da-lu-jing-chang-du.md)
      * [Transformers for Vision](deep-learning/transformer-and-attention-mechanism/the-transformer-architecture/transformers-for-vision.md)
    * [Large-Scaling Pretraning with Transformers](deep-learning/transformer-and-attention-mechanism/large-scaling-pretraning-with-transformers/README.md)
      * [BERT vs GPT vs T5](deep-learning/transformer-and-attention-mechanism/large-scaling-pretraning-with-transformers/bert-vs-gpt-vs-t5.md)
      * [Supplement比较](deep-learning/transformer-and-attention-mechanism/large-scaling-pretraning-with-transformers/supplement-bi-jiao.md)
      * [编码器-解码器架构 vs GPT 模型](deep-learning/transformer-and-attention-mechanism/large-scaling-pretraning-with-transformers/bian-ma-qi-jie-ma-qi-jia-gou-vs-gpt-mo-xing.md)
  * [LLM Pretraining](deep-learning/llm-pretraining/README.md)
    * [Word Embedding(word2vec)](deep-learning/llm-pretraining/word-embedding-word2vec/README.md)
      * [Extra Reading](deep-learning/llm-pretraining/word-embedding-word2vec/extra-reading.md)
    ...
    * [Bidirectional Encoder Representations from Transformers(BERT)](deep-learning/llm-pretraining/bidirectional-encoder-representations-from-transformers-bert/README.md)
      * [Extra Reading](deep-learning/llm-pretraining/bidirectional-encoder-representations-from-transformers-bert/extra-reading.md)
    * [Decoding(GPT& Lamma)](deep-learning/llm-pretraining/decoding-gpt-and-lamma.md)
    * [Encoder-Decoder(T5)](deep-learning/llm-pretraining/encoder-decoder-t5.md)
...
* [Machine Learning System Design](machine-learning-system-design.md)
  * [GenAI六个阶段](machine-learning-system-design/genai-liu-ge-jie-duan.md)
